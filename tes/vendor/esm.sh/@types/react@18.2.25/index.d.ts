...
import * as CSS from "../../csstype@3.1.2/index.d.ts";
import * as PropTypes from "../../@types/prop-types@15.7.8/index.d.ts";
import { Interaction as SchedulerInteraction } from "../../@types/scheduler@0.16.4/tracing.d.ts";
